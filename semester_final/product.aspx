<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="semester_final.product" %>
	...
	<div class="content">
		<div class="container">
			...
			<div class="f-r span658">
				<div class="titlebox">
					<h2 class="f-l">产品中心</h2>
					<div class="f-r searchbox">
					<form method="post" name="" id="">
						<div class="stext"><input type="text" name="" value="" id="" /></div>
						<input type="submit" name="" id="" value="" class="btn-img" />
					</form>	
					</div>
				</div>
				<div class="product">
					<ul class="clearfix">
                        <asp:Repeater runat="server" ID="productList" >
                            <ItemTemplate>    
						        <li>
							        <a href="product_detail.aspx?productId=<%# Eval("id") %>"><img src="./admin/upload_images/<%# Eval("photo_url") %>" width="150" height="136" alt="<%# Eval("title") %>" /></a>
