<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add.aspx.cs" Inherits="semester_final.admin.add" validateRequest="false" %>
  ...
  <div class="body-content">
    <%--<form method="post" class="form-x" action="">--%>  
      ...
      <div class="form-group">
        ...
        <div class="field">
            <%--<asp:Image ID="showUploadImg"/>--%>
            <asp:FileUpload class="button bg-blue margin-left" Text="+ 浏览上传" style="float:left;" ID="FileUpload1" runat="server" />
                
          <%--<input type="text" id="url1" name="img" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="images/11.jpg" />--%>
            
          <%--<input type="button" class="button bg-blue margin-left" id="image1" value="+ 浏览上传"  style="float:left;">--%>
            <%--<asp:Button ID="uploadBtn" class="button bg-blue margin-left"  runat="server" Text="+ 浏览上传" style="float:left;" OnClick="uploadBtn_Click" />--%>
