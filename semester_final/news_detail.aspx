<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news_detail.aspx.cs" Inherits="semester_final.news_detail" %>
		...
		<div class="container">
			...
			<div class="f-r span658">
				...
				<div class="newsdetail">
					<h1><%=semester_final.news_detail.title %></h1>
					<div class="newsinfo">
						<div class="f-l newsdis"><span>来源:<%=semester_final.news_detail.origin %></span>
                            <span>发布时间:<%=semester_final.news_detail.createTime %></span>
                            <span>浏览：<%=semester_final.news_detail.readCount %></span></div>
					...
					<div class="fontsizebox"><%=semester_final.news_detail.aContent %></div>
					<p class="a-c" style="margin-top:20px;"><a style="font-size:14px;color:#ff6600;text-decoration:underline;"  onclick="history.go(-1)">返 回</a></p>
				</div>
