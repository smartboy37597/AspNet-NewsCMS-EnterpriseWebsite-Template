<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="news.aspx.cs" Inherits="semester_final.news" %>
				...
				<div class="newsbox">
					<ul>
						...
						<asp:Repeater runat="server" ID="newslist" >
                            <ItemTemplate>                         
                                <li><a href="news_detail.aspx?newsId=<%# Eval("id") %>"><%# Eval("title") %></a><div class="date"><%# Eval("create_time") %></div></li>
                                <%--<li><a href="news-detail.html">回收橡胶助剂及有机颜料【采购】</a><div class="date">2010-06-21 17:30</div></li>--%>
                            </ItemTemplate> 
                        </asp:Repeater>
					</ul>
				</div>
