<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_detail.aspx.cs" Inherits="semester_final.product_detail" %>
		...
		<div class="container">
			...
			<div class="f-r span658">
				...
				<div class="product-detail">
					...
					<p class="a-c"><img src="./admin/upload_images/<%=semester_final.product_detail.photoUrl %>" width="500" height="348" alt="<%=semester_final.product_detail.title %>" /></p>
					<%=semester_final.product_detail.aContent %>
